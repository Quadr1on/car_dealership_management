...
def Admin():
    ...
    def deletedata():
        ...
        l=[sno]
        qry = "delete from car_data where sno = %s"
        cur.execute(qry,l)
        con.commit()
    ...
    def total():
        qry = 'select sum(selling_price) from car_data'
        cur.execute(qry)
        x = cur.fetchall()
        header=['Total Value']
        print(tabulate(x,header,tablefmt="pretty"))
    ...
    while True:
        ...
        print('5.total Value of all the cars')
        print("6.Count all the cars present in the Database")
...
def User():
    ...
    def Graph():
        ...
        def visualizeCarPrices():
            ...
            ax.bar(range(len(selling_prices)), selling_prices, color='Lightblue')
    ...
    while True:
        ...
        print("1.Display all")
        print("2.Search")
        print("3.Highest priced vehicle")
        print("4.Lowest priced vehicle")
        print("5.Graphs of  Our DataBase")
